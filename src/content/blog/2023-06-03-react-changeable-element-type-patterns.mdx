...
render(
	<>
		<Button type="button">I’m a <code>button</code> element</Button>
		<Button as="a" href="/">I’m an <code>a</code> element</Button>
	</>
);
```
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">I&#39;ve been thinking a lot about the `as` prop for polymorphism lately and wondering why we all went down the road of runtime TypeScript polymorphism. It introduces so many unnecessary complexities, bloats error messages and kills TS perf... 🧵</p>&mdash; jenna (@jjenzz) <a href="https://twitter.com/jjenzz/status/1423766700885954562?ref_src=twsrc%5Etfw">August 6, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
