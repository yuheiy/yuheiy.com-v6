...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/004.png)<figcaption>[Showing results for https://dist.connpass.com/event/261960/ - Nu Html Checker](https://validator.w3.org/nu/?doc=https%3A%2F%2Fdist.connpass.com%2Fevent%2F261960%2F)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/010.png)<figcaption>[制作者のためのHTML](https://yuheiy.github.io/html-for-creators/)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/011.png)<figcaption>[HTML解体新書 | ボーンデジタル](https://www.borndigital.co.jp/book/25999.html)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/012.png)<figcaption>[Accessibility Object Model | aom](https://wicg.github.io/aom/explainer.html)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/013.png)<figcaption>[Patterns | APG | WAI | W3C](https://www.w3.org/WAI/ARIA/apg/patterns/)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/014.png)<figcaption>[Accessibility Support](https://a11ysupport.io/)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/015.png)<figcaption>[総務省｜情報バリアフリー環境の整備｜障害者のウェブページ利用方法の紹介ビデオ](https://www.soumu.go.jp/menu_news/s-news/2005/051215_1_wmv.html)</figcaption></figure>

加えて、実際のユーザーの利用状況についての調査結果なども公開されています。こうしたものにも目を通しておくと参考にできることがあります。

{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/016.png)<figcaption>[第2回支援技術利用状況調査報告書 | 日本視覚障害者ICTネットワーク](https://jbict.net/survey/at-survey-02)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/017.png)<figcaption>[Introducing WordPress 6.0 - YouTube](https://www.youtube.com/watch?v=oe452WcY7fA)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/018.png)<figcaption>[電子書籍版インクルーシブHTML+CSS & JavaScript | ボーンデジタル](https://www.borndigital.co.jp/book/6610.html)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![](./assets/2022-11-03-how-to-understand-the-markup/019.png)<figcaption>[利用規約 - connpass](https://connpass.com/term/)</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![典型的な教科書の前付けページの構成がツリーダイアグラムとして表現されている](./assets/2022-11-03-how-to-understand-the-markup/020.jpg)<figcaption>Martin Bryan『SGML入門』（福島誠訳）</figcaption></figure>
...
{/* prettier-ignore */}
<figure>![料理のレシピについて文書分析する例として、最終的に紙に印刷されるレシピをサンプルにしつつ、レシピで使う要素を例示している。\<head1>、\<p1>、\<p2>、\<p3>、\<p4>、\<pr>、\<pl>、\<it>](./assets/2022-11-03-how-to-understand-the-markup/021.jpg)<figcaption>B.トラビス, D.ウォルト『SGML実践ガイド』（学研, スリーエーシステムズSGML事業室 訳）</figcaption></figure>
