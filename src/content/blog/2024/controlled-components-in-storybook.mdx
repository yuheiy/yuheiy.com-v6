...
<figure>
  <video controls playsinline>
    <source
      src={
        (await import('./assets/controlled-components-in-storybook/without-useargs.mp4')).default
      }
    />
  </video>
</figure>
...
<figure>![](./assets/controlled-components-in-storybook/hide-control.png)</figure>
