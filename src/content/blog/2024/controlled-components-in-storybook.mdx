---
legacyUrl: true
slug: 2024-07-09-controlled-components-in-storybook
...
<video controls playsinline>
  <source
    src={(await import('./assets/controlled-components-in-storybook/without-useargs.mp4')).default}
  />
</video>
...
import withUseArgsVideo from './assets/controlled-components-in-storybook/with-useargs.mp4';
...
![](./assets/controlled-components-in-storybook/hide-control.png)
...
[その他の使用例は同リポジトリから参照できる](https://github.com/search?q=repo%3Aadobe%2Freact-spectrum%20useControlledState(&type=code)。
