...
<figure>
  <Image class="w-64" src={import('./assets/2022-08-13-change-the-icon/before.png')} alt="" />
  <figcaption>これまでのプロフィール画像</figcaption>
</figure>

<figure>
  <Image class="w-64" src={import('./assets/2022-08-13-change-the-icon/after.png')} alt="" />
