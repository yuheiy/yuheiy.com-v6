...
import _1Image from "./assets/2022-08-12-shrinkable-min-width/1.png";

<figure>
	<Image src={_1Image} alt="" style="width: calc(840/2/16*1rem);" />
</figure>
...
>
	<span>
		See the Pen <a href="https://codepen.io/yuheiy/pen/PoRdReV">Untitled</a> by Yuhei Yasuda (
