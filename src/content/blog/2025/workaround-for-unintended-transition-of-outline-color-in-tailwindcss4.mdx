...
<figcaption>
  — [third_party/blink/renderer/core/html/resources/html.css - chromium/src.git - Git at
  Google](https://chromium.googlesource.com/chromium/src.git/+/refs/tags/140.0.7306.1/third_party/blink/renderer/core/html/resources/html.css#1344)
</figcaption>
...
<figcaption>
  — [Upgrade guide - Getting started - Tailwind
  CSS](https://tailwindcss.com/docs/upgrade-guide#transitioning-outline-color)
</figcaption>
...
<figcaption>
  — [tailwindcss/packages/tailwindcss/src/utilities.ts at v4.1.11 ·
  tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss/blob/v4.1.11/packages/tailwindcss/src/utilities.ts#L4502-L4511)
</figcaption>
...
<figcaption>
  — [tailwindcss/packages/tailwindcss/src/utilities.ts at v4.1.11 ·
  tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss/blob/v4.1.11/packages/tailwindcss/src/utilities.ts#L4478)
</figcaption>
