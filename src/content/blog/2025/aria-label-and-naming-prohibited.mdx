...
<figcaption>
  &mdash;{' '}
  <cite>
    [ARIA in HTML 日本語訳 § 4.1
    要素に名前を付けるためのARIA属性の使用に関する要件](https://momdo.github.io/html-aria/#docconformance-naming)
  </cite>
</figcaption>
...
<figcaption>
  &mdash;{' '}
  <cite>
    [Accessible Rich Internet Applications (WAI-ARIA) 1.2 日本語訳 § 5.2.8.6
    名前を付けることができないロール（名前は禁止されている）](https://momdo.github.io/wai-aria-1.2/#namefromprohibited)
  </cite>
</figcaption>
